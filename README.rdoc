...
by {Andrea Franz}[http://gravityblast.com] to Rails 3 in the form of Rails 3 generators.
...
layout. You need to remove it to make the haml-file take its place.
...
Haml support is included. If you have Haml included in your apps Gemfile,
web-app-theme-rails produces haml-templates per default.
